...
import sys
import os
import utils.extract_streams_for_oud_yes as ext_strs
import logging
...
if  parser.parse_args().cohort == "oud_yes":
    parser.add_argument("--meds_rawdata_filename", type=str, default='data/oud_yes_icd_presc_based_prescriptions_view_sorted.csv')    
    parser.add_argument("--diags_rawdata_filename", type=str, default='data/oud_yes_icd_presc_based_diagnoses_view_sorted.csv')
    ...
    parser.add_argument("--meds_rawdata_filename", type=str, default='data/oud_no_icd_presc_based_prescriptions_view_sorted.csv')    
    parser.add_argument("--diags_rawdata_filename", type=str, default='data/oud_no_icd_presc_based_diagnoses_view_sorted.csv')

...
def main(idx,test_filename_meds, test_filename_diags, test_filename_procs, test_filename_demogs, checkpoint_path, best_model_number, learning_rate, num_layers, num_heads, BATCH_SIZE, dropout_rate, EPOCHS, optimum_threshold, regu_factor): 
  ...
  # np.savetxt('results/MUPOD/restoring_best_model_logits_test_twostreamT_KFold'+str(idx)+'_'+str(best_model_number)+'.csv', logits_test_all, delimiter=',')
  # np.savetxt('results/MUPOD/restoring_best_model__softmax_test_KFold'+str(idx)+'_'+str(best_model_number)+'.csv', predictions_test_soft.numpy(), delimiter=',')
...
if __name__ == "__main__": main(idx,test_filename_meds, test_filename_diags, test_filename_procs, test_filename_demogs, checkpoint_path, best_model_number, learning_rate, num_layers, num_heads, BATCH_SIZE, dropout_rate, EPOCHS, optimum_threshold, regu_factor) 

...
def main(idx, drp, representing, epochs, reg_coeff, learning_rt,n_hid, batch_sz, trained_model_path, test_meds_filename, test_diags_filename, test_procs_filename, test_demogs_filename, test_metadata_filename):
    tf.compat.v1.reset_default_graph()
    # pdb.set_trace()
    print("Loading the single stream LSTM model ...")
...
if __name__ == "__main__": main(idx, drp,representing, epochs, reg_coeff, learning_rt, n_hid, batch_sz, trained_model_path, test_meds_filename, test_diags_filename, test_procs_filename, test_demogs_filename, test_metadata_filename)

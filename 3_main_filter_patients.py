...
if  parser.parse_args().cohort == "oud_yes":
    ...
    parser.add_argument("--demogs_rawdata_filename", type=str, default='data/oud_yes_icd_presc_based_demographics_view.csv')       
    ...
    parser.add_argument("--demogs_rawdata_filename", type=str, default='data/oud_no_icd_presc_based_demographics_view.csv') 

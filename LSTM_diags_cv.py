import  models.LSTM_diags_model as lsad
import os
...
softmax_predictions_temp, accuracy_temp, precision, recall, sensitivity, specificity, tp, tn, fp, fn, test_auc =lsad.main(model_number, dropout_r, representing, num_epochs, regu_fact, learning_r, n_hid , batch_sz, train_diags_filename, train_metadata_filename, test_diags_filename, test_metadata_filename)
np.savetxt('results/LSTM_diags/softmax_predictions_LSTM_diags.csv', softmax_predictions_temp, delimiter=',')
...
with open('results/LSTM_diags/Results_test_LSTM_diags.csv', 'w') as res_f:

...
test_data_stationary = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_stationary_normalized_features_filtered.csv')
...
for i in range(len(test_data_stationary_pos_kfolds)):
    ...
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_stationary_normalized_features_filtered_fold'+str(fold_counter)+'.csv', index=False)
    fold_counter +=1
...
fold_counter=0 
test_data_single_stream = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_meds_diags_procs_demogs_represented.csv', header=None)
for i in range(len(test_data_stationary_pos_kfolds)):
    ...
    # temp_test_fold = temp_test_fold.sample(frac=1)
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_meds_diags_procs_demogs_represented_fold'+str(fold_counter)+'.csv', index=False, header=False)
    fold_counter +=1
    if fold_counter % 10 ==0:
        print(fold_counter)
...
fold_counter=0 
test_data_multi_stream_meds = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_meds_represented.csv', header=None)
test_data_multi_stream_diags = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_diags_represented.csv', header=None)
test_data_multi_stream_procs = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_procs_represented.csv', header=None)
test_data_multi_stream_demogs = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_demographics_multihot.csv', header=None)
for i in range(len(test_data_stationary_pos_kfolds)):
    ...
    temp_test_fold = pd.concat([temp_test_fold_pos, temp_test_fold_neg])
    # temp_test_fold = temp_test_fold.sample(frac=1)
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_meds_represented_fold'+str(fold_counter)+'.csv', index=False, header=False)
    ...
    temp_test_fold = pd.concat([temp_test_fold_pos, temp_test_fold_neg])
    # temp_test_fold = temp_test_fold.sample(frac=1)
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_diags_represented_fold'+str(fold_counter)+'.csv', index=False, header=False)
    ...
    temp_test_fold = pd.concat([temp_test_fold_pos, temp_test_fold_neg])
    # temp_test_fold = temp_test_fold.sample(frac=1)
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_procs_represented_fold'+str(fold_counter)+'.csv', index=False, header=False)
    ...
    temp_test_fold = pd.concat([temp_test_fold_pos, temp_test_fold_neg])
    # temp_test_fold = temp_test_fold.sample(frac=1)
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_demographics_multihot_fold'+str(fold_counter)+'.csv', index=False, header=False)
...
fold_counter=0 
test_data_multi_raw_meds = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_medications_multihot.csv', skiprows=1, header=None)
test_data_multi_raw_diags = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_diagnoses_multihot.csv', skiprows=1, header=None)
test_data_multi_raw_procs = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_procedures_multihot.csv', skiprows=1, header=None)
test_data_multi_raw_demogs = pd.read_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_demographics_shuffled.csv')
for i in range(len(test_data_stationary_pos_kfolds)):
    # pdb.set_trace()
    ...
    temp_test_fold = pd.concat([temp_test_fold_pos, temp_test_fold_neg])
    # temp_test_fold = temp_test_fold.sample(frac=1)
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_medications_multihot_fold'+str(fold_counter)+'.csv', index=False, header=True)
    ...
    temp_test_fold = pd.concat([temp_test_fold_pos, temp_test_fold_neg])
    # temp_test_fold = temp_test_fold.sample(frac=1)
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_diagnoses_multihot_fold'+str(fold_counter)+'.csv', index=False, header=True)
    ...
    temp_test_fold = pd.concat([temp_test_fold_pos, temp_test_fold_neg])
    # temp_test_fold = temp_test_fold.sample(frac=1)
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_procedures_multihot_fold'+str(fold_counter)+'.csv', index=False, header=True)
    ...
    temp_test_fold = pd.concat([temp_test_fold_pos, temp_test_fold_neg])
    # temp_test_fold = temp_test_fold.sample(frac=1)    
    temp_test_fold.to_csv('/data/scratch/sfouladvand/RISK/comparative_study/outputs/test_demographics_shuffled_fold'+str(fold_counter)+'.csv', index=False, header= True)
